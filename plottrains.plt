...
set xtics font "segoe ui,7" 
set ytics font "segoe ui,8" 
...
set yrange [ 0.75 : 0.0] noreverse nowriteback
...
set rmargin  -1
set tmargin  -1
#set offsets graph 0, 0, -0.5, 0.00
...
set key;  unset border; unset xlabel; unset ylabel
GNUTERM = "wxt
unset key
plot 'e:\ann\train_hist.dat' using 1:2 '%lf %lf %lf' lw 2 with lines , '' using 1:3 '%lf %lf %lf' lw 2 lt 2 with lines, '' using 1:4 '%lf %lf %lf %lf' lw 2 lt 2 with lines, '' using 1:5 '%lf %lf %lf %lf %lf' pt 5 ps 0.4 
#,'' using 1:6 '%lf %lf %lf %lf %lf %lf' pt 5 ps 0.3
