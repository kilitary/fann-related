...
GNUTERM = "wxt
unset key
plot 'e:\ann\train_hist.dat' using 1:2 '%lf %lf %lf' lw 2 with lines , '' using 1:3 '%lf %lf %lf' lw 2 lt 2 with lines, '' using 1:4 '%lf %lf %lf %lf' with lines  , '' using 1:5 '%lf %lf %lf %lf %lf' pt 3 with lines
