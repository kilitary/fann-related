...
GNUTERM = "wxt"
plot 'e:/ann/cascade_hist.dat' using 1:2 '%lf %lf %lf' with lines, '' using 1:3 '%lf %lf %lf' with lines,'' using 1:4 '%lf %lf %lf %lf' pt 9 ps 0.1 , '' using 1:5 '%lf %lf %lf %lf %lf' pt 9 ps 0.1 
pause 1
reread
refresh
call 'plot.plt'
